...
const MultiStepForm = ({ user_id }) => {
  ...
  const handleNext = (e) => {
    ...
    if (step === 1) {
      ...
      if (formData.step1.firstName.trim() === "") {
        ...
        step1isValid  = false;
      } else if (!nameRegex.test(formData.step1.firstName.trim())) {
        setFirstNameError(" should contain only letters and spaces");
        step1isValid  = false;
      } else {
        setFirstNameError("");
      }
      ...
      if (formData.step1.lastName.trim() === "") {
        ...
        step1isValid  = false;
      } else if (!nameRegex.test(formData.step1.lastName.trim())) {
        setLastNameError(" should contain only letters and spaces");
        step1isValid  = false;
      } else {
        setLastNameError("");
      }
    ...
    // Step 3 Validations
      ...
      if (formData.step3.pincode.trim() === "") {
  ...
  const handleSubmit = (e) => {
    ...
    const payload = {
      ...
      mobileNumber: formData.step2.mobileNumber,
      email: formData.step2.email,
      education: formData.step2.education,
      workStatus: formData.step2.workStatus,
    ...
    axios
      .post(`http://localhost:8080/api/applicant?userId=${user_id}`, payload)
      .then((response) => {
      ...
      <div>
        ...
        {step === 3 && (
          <div className="loan-application-container">
            ...
            <label className="loan-application-label">
              Pin Code :<span style={{ color: "red" }}>{pincodeError}</span>{" "}
            </label>
            <div className="loan-application-form">
              <input
                className="loan-application-input"
